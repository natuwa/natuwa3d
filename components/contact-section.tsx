          ...
          <div className="space-y-8">
            ...
            <div className="pt-8 border-t border-border">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://wa.me/919560672813" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center text-primary hover:bg-primary hover:text-white">
