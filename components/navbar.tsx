...
export function Navbar() {
  ...
  className="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded-md inline-block">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-background border-b border-border py-4 px-6 z-50">
            <div className="flex flex-col gap-4">
              ...
              <a
                ...
                onClick={() => {
                  setIsOpen(false);
                  window.open(
                    "https://docs.google.com/forms/d/e/1FAIpQLSeBD0w5-UBiK0ZF5UGAA-RrI41OaGaBodq67aEMiVJNUcPMLw/viewform",
                    "_blank"
                  );
                }}
